...
class FlappyBird(base.PyGameWrapper):
    ...
    def _load_images(self):
        ...
        for b in ["day", "night", "empty"]: #KETILL EDIT bætti við "empty"
    ...
    def init(self):
        ...
        self.backdrop.background_image = self.images["background"]["empty"] #KETILL EDIT color <- "empty"

        # instead of recreating
        color = self.rng.choice(["red", "blue", "yellow"])
        self.player.init(self.init_pos, "yellow") #KETILL EDIT color <- "yellow"

        self.pipe_color = "green" #self.rng.choice(["red", "green"]) KETILL EDIT
